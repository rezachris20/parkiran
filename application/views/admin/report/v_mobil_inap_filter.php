...
<div class="content mt-3">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
            	<div class="col-md-3">
            		<form class="form-inline" method="POST" action="<?php echo base_url().'rmobilinap' ?>">
            		...
            		<br/>
            		 <a href="<?php echo base_url().'rmobilinap/laporan_pdf/?dari='.set_value('dari').'&sampai='.set_value('sampai')?>">
                     ...
                     &nbsp&nbsp
                    <a href="<?php echo base_url().'rmobilinap/laporan_excel/?dari='.set_value('dari').'&sampai='.set_value('sampai')?>">
